            ...
            <div className='md:w-[50%]'>
                <div className=' bg-gray-900/75 w-[80%] md:min-w-[400px] h-[240px] m-auto'>
                    <div className='relative'>
                        <div className=' absolute w-[25%] text-sm md:text-base xl:text-lg  bg-cyan-900/50 h-[20px] left-2 top-2 rounded-tr-full font-Handjet pl-2 md:pl-4 font-semibold'>
                            0{planet.index}-{planet.name}
                        </div>
